...
import { RiBillLine, RiReceiptLine, RiMoneyDollarBoxLine, RiChatNewLine, RiUploadCloud2Line, RiCircleFill } from "react-icons/ri";
import moment from "moment";
import ui from "@/app/data/ui.json";
import statuses from "@/app/types/status";

export default function TopBar({ salesData, setCommentDialog, setUploadDialog, handleStatusChange }) {
