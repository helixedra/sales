...
export function RequestFormContent({
  ...
  const isDiscounted =
    order?.items
      .map((item: Item) => Number(item.discount) > 0)
          ...
          <table className="w-full border-collapse mb-8" cellPadding="8">
            <thead>
              <tr className="font-semibold border-t-[3px] border-t-double border-t-black border-b border-b-black">
                <td className="px-4  border-r border-l border-gray-300">
                  {ui.global.num}
                </td>
            ...
            <tbody>
              {order?.items.map((item: Item, index: number) => (
                ...
                >
                  <td className="px-4 text-center  border-l border-r border-gray-300">
                    {index + 1}
                  </td>
                  <td className="px-4 border-r border-gray-300">
                    {item.description}
                  ...
                  <td className="px-4 border-r border-gray-300 text-right whitespace-nowrap">
              ...
              <tr className="border-t-2 border-t-black font-semibold">
                ...
                <td className="px-4 "></td>
                <td className="px-4"></td>
                {isDiscounted && <td className="px-4 "></td>}
